 ...
 *
 * Thank you Square, Inc.
 * @modified Eoin Fogarty
 */
public class RotateDetector implements SensorEventListener{
    /**
    ...
    public RotateDetector(Listener listener) {
    ...
    @Override public void onSensorChanged(SensorEvent event) {
        ...
        if (queue.isRotating()) {
            //TODO MAYBE CHANGE HERE TO HEAR ONLY ONCE
            queue.clear();
            listener.hearRotation();
        }
    }
...
//        float az = event.values[2];
        ...
        return ax > ACCELERATION_THRESHOLD;
    }
    ...
    static class SampleQueue {
        ...
        private static final long MAX_WINDOW_SIZE = 500000000; // .5s
